...
use CodeIgniter\Test\Mock\MockSecurityNew;
 ...
 * @internal
 */
final class SecurityNewTest extends CIUnitTestCase
{
    ...
    {
        $security = new SecurityNew(new MockAppConfig());
    ...
    private function createSecurity(?AppConfig $appConfig = null, ?SecurityConfig $securityConfig = null): SecurityNew
    {
        $appConfig = $appConfig ?? new MockAppConfig();
        $security  = new MockSecurityNew($appConfig);
    ...
    {
        $security = new MockSecurityNew(new MockAppConfig());
    ...
    public function testCSRFVerifyPostReturnsSelfOnMatch()
    {
        ...
        $this->assertInstanceOf(SecurityNew::class, $security->verify($request));
