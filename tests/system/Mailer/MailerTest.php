...
final class MailerTest extends CIUnitTestCase
{
    ...
    public function testDefaultWithCustomConfig()
    {
        ...
        $this->assertSame(76, $mailer->wrapChars);
        $this->assertSame('text', $mailer->mailType);
        $this->assertSame('UTF-8', $mailer->charset);
        $this->assertSame('', $mailer->altMessage);
    ...
    public function testSetFromMailerOnly()
    {
        ...
        $this->assertSame(' <leia@alderaan.org>', $mailer->getHeader('From'));
        $this->assertSame('<leia@alderaan.org>', $mailer->getHeader('Return-Path'));
    }
    ...
    public function testSetFromMailerAndName()
    {
        ...
        $this->assertSame('"Princess Leia" <leia@alderaan.org>', $mailer->getHeader('From'));
        $this->assertSame('<leia@alderaan.org>', $mailer->getHeader('Return-Path'));
    }
    ...
    public function testSetFromMailerAndFunkyName()
    {
        ...
        $this->assertSame('=?UTF-8?Q?Princess=20Lei=C3=A0?= <leia@alderaan.org>', $mailer->getHeader('From'));
        $this->assertSame('<leia@alderaan.org>', $mailer->getHeader('Return-Path'));
    }
    ...
    public function testSetFromWithValidationAndDifferentReturnPath()
    {
        ...
        $this->assertSame('"Princess Leia" <leia@alderaan.org>', $mailer->getHeader('From'));
        $this->assertSame('<padme@naboo.org>', $mailer->getHeader('Return-Path'));
    }
    ...
    public function testSetReplyToMailerOnly()
    {
        ...
        $this->assertSame(' <leia@alderaan.org>', $mailer->getHeader('Reply-To'));
    }
    ...
    public function testSetReplyToMailerAndName()
    {
        ...
        $this->assertSame('"Princess Leia" <leia@alderaan.org>', $mailer->getHeader('Reply-To'));
    }
    ...
    public function testSetReplyToMailerAndFunkyName()
    {
        ...
        $this->assertSame('=?UTF-8?Q?Princess=20Lei=C3=A0?= <leia@alderaan.org>', $mailer->getHeader('Reply-To'));
    }
    ...
    public function testSetToBasic()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->recipients, true));
    }
    ...
    public function testSetToArray()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->recipients, true));
        $this->assertTrue(in_array('padme@naboo.org', $mailer->recipients, true));
    }
    ...
    public function testSetToInvalid()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine', $mailer->recipients, true));
    }

    public function testDontSetToInvalid()
    {
        $this->expectException(\CodeIgniter\Mailer\Exceptions\MailerException::class);
    ...
    public function testSetToHeader()
    {
        ...
        $mailer->setTo('Luke <luke@tatooine.org>');
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->recipients, true));
        $this->assertSame('luke@tatooine.org', $mailer->getHeader('To'));
    }
    ...
    public function testSetCCBasic()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->CCArray, true));
    }
    ...
    public function testSetCCArray()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->CCArray, true));
        $this->assertTrue(in_array('padme@naboo.org', $mailer->CCArray, true));
        $this->assertSame('luke@tatooine.org, padme@naboo.org', $mailer->getHeader('Cc'));
    }
    ...
    public function testSetCCInvalid()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine', $mailer->CCArray, true));
    }
    ...
    public function testSetCCHeader()
    {
        ...
        $mailer->setCC('Luke <luke@tatooine.org>');
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->CCArray, true));
        $this->assertSame('luke@tatooine.org', $mailer->getHeader('Cc'));
    }
    ...
    public function testSetBCCBasic()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->BCCArray, true));
    }
    ...
    public function testSetBCCArray()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->BCCArray, true));
        $this->assertTrue(in_array('padme@naboo.org', $mailer->BCCArray, true));
        $this->assertSame('luke@tatooine.org, padme@naboo.org', $mailer->getHeader('Bcc'));
    }
    ...
    public function testSetBCCInvalid()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine', $mailer->BCCArray, true));
    }
    ...
    public function testSetBCCHeader()
    {
        ...
        $mailer->setBCC('Luke <luke@tatooine.org>');
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->BCCArray, true));
        $this->assertSame('luke@tatooine.org', $mailer->getHeader('Bcc'));
    }
    ...
    public function testSetBCCBiggerBatch()
    {
        ...
        $this->assertTrue(in_array('luke@tatooine.org', $mailer->BCCArray, true));
        $this->assertTrue(in_array('padme@naboo.org', $mailer->BCCArray, true));
        $this->assertSame('luke@tatooine.org, padme@naboo.org, leia@alderaan.org', $mailer->getHeader('Bcc'));
    }
    ...
    public function testSetSubject()
    {
        ...
        $this->assertSame($expected, $mailer->getHeader('Subject'));
    }
    ...
    public function testSetMessage()
    {
        ...
        $this->assertSame($expected, $mailer->body);
    }
    ...
    public function testSetAltMessage()
    {
        ...
        $this->assertSame($expected, $mailer->altMessage);
    }
    ...
    public function testSetMultilineAltMessage()
    {
        ...
        $original = "Just a silly love song\r\nIt's just two lines long";
        $mailer->setAltMessage($original);
        $this->assertSame($original, $mailer->altMessage);
    }
    ...
    public function testClearing()
    {
        ...
        $mailer->clear(true);
        $this->assertSame('', $mailer->getHeader('From'));
        $this->assertSame('', $mailer->getHeader('To'));
    ...
    public function testAttach()
    {
        ...
        $this->assertCount(1, $mailer->attachments);
    }
    ...
    {
        $mailer = new Mailer();
        $this->assertSame('mail', $mailer->getProtocol()); // default
        $mailer->setProtocol('smtp');
        $this->assertSame('smtp', $mailer->getProtocol());
        $mailer->setProtocol('mail');
        $this->assertSame('mail', $mailer->getProtocol());
    }
    ...
    public function testWordWrapVanilla()
    {
        ...
        $expected = $original;
        $this->assertSame($expected, rtrim($mailer->wordWrap($original)));
    }
    ...
    public function testWordWrapShortLines()
    {
        ...
        $this->assertSame($expected, rtrim($mailer->wordWrap($original, 16)));
    }
    ...
    public function testMagicMethods()
    {
        ...
        $this->assertSame('mail', $mailer->protocol);
    }
